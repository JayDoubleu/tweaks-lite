...
class TweaksLiteWindow(Adw.ApplicationWindow):
    ...
    def setup_sidebar(self):
        ...
        self.sidebar_list = Gtk.ListBox(
            css_classes=["navigation-sidebar"], selection_mode=Gtk.SelectionMode.SINGLE
        )
        ...
        sidebar_page = Adw.NavigationPage(
            title="Tweaks Lite", child=self.sidebar_toolbar_view
        )
    ...
    def add_sidebar_separator(self, list_box):
        ...
        row = Gtk.ListBoxRow(
            selectable=False, activatable=False, css_classes=["compact"]
        )
        ...
        try:
            ...
            if not view:
                view_module = __import__(
                    f"tweakslite.views.{view_name}", fromlist=["View"]
                )
